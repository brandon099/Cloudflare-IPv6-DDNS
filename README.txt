# Cloudflare-DDNS Script and Installer
Description: 
...
To help you get this information easily please download cf-install.sh, make it executable and execute it. It will walk you through and create a working cf-ddns.sh script that you can execute.
